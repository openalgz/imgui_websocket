...
struct ImGuiWS
{
   ...
   bool init(int32_t port, std::string http_root, std::vector<std::string> resources);
   bool init(int32_t port, std::string http_root, std::vector<std::string> resources, THandler&& connect_handler,
